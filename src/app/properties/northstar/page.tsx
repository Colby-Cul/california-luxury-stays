...
const THE_SPACE = "5,000 sq ft remodeled home on two levels. Main floor: great room with vaulted ceilings and gas fireplace, chef's kitchen with premium appliances, dining area seats 12, 2 bedrooms and 2 bathrooms including a master suite. Upper level: 5 bedrooms and 4 bathrooms including the primary master suite with king bed and spa-style en-suite, family room with games, media room with projector. Expansive deck with hot tub and mountain views. Heated 2-car garage with ski and snowboard storage.";
    ...
    <div className="min-h-screen bg-charcoal-800 text-stone-100">
      ...
      <section className="pt-20">
        <div className="mx-auto max-w-7xl px-6 pt-8 lg:px-10">
          <PhotoGrid photos={PHOTOS} propertyId="northstar" />
