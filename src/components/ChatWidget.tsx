  ...
  return (
    <>
      ...
      <button
        ...
        className={`fixed bottom-6 right-6 z-50 flex items-center justify-center rounded-full bg-gold-400 text-charcoal-800 shadow-xl transition hover:bg-gold-300 hover:scale-105 hover:shadow-2xl group ${isOpen ? "h-12 w-12" : "h-12 w-12"}`}
      ...
      >
        {isOpen ? (
          ...
          <>
            ...
            <span className="absolute right-14 whitespace-nowrap rounded-lg bg-charcoal-700 px-3 py-1.5 text-xs font-semibold text-white shadow-lg opacity-0 group-hover:opacity-100 transition pointer-events-none">Chat with us</span>
          </>
        )}
      </button>
            ...
            <div className="flex items-center gap-3 border-b border-gold-400/10 bg-charcoal-800 px-4 py-3">
              ...
              <div>
                <div className="flex items-center gap-2">
                  <p className="text-sm font-semibold text-white">Christine</p>
                  <span className="h-2 w-2 rounded-full bg-emerald-400 shadow-[0_0_6px_rgba(52,211,153,0.5)]" />
                </div>
                <p className="text-xs text-stone-400">Customer Service</p>
              </div>
            </div>
              ...
              {messages.length === 0 && (
                <div className="space-y-3">
                  <p className="text-sm text-stone-400">
                    Hi there! I&apos;m Christine, your personal concierge at California Luxury Stays. How can I help you today?
                  </p>
